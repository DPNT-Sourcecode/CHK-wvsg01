...
describe('Checkout: valid requests', function () {
  ...
  it('Should return 1602', function () {
    assert.equal(checkout('ABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZ'), 1602)
  })

  it('Should return 1602', function () {
    assert.equal(checkout('LGCKAQXFOSKZGIWHNRNDITVBUUEOZXPYAVFDEPTBMQLYJRSMJCWH'), 1602)
  })
})