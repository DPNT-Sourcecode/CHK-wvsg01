...
describe('Checkout: valid requests', function () {
  ...
  //   assert.equal(checkout('SXZSXZ'), 90)
  // })

  // it('Should return 290', function () {
  //   assert.equal(checkout('SXZSXZAAAAA'), 290)
  // })

  // it('Should return 290', function () {
  //   assert.equal(checkout('AAAAASXZSXZ'), 290)
  // })
...
// - {"method":"checkout","params":["Z"],"id":"CHK_R5_028"}, expected: 21, got: 50
// - {"method":"checkout","params":["SSS"],"id":"CHK_R5_141"}, expected: 45, got: 60
// - {"method":"checkout","params":["SSSZ"],"id":"CHK_R5_142"}, expected: 65, got: 110
