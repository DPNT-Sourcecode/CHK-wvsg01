...
describe('Checkout: valid requests', function () {
  ...
  it('Should return 90', function () {
    assert.equal(checkout('STXSTX'), 90)
  })
})

/*

Some requests have failed (3/149). Here are some of them:
 - {"method":"checkout","params":["STXSTX"],"id":"CHK_R5_140"}, expected: 90, got: 99
 - {"method":"checkout","params":["ABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZ"],"id":"CHK_R5_147"}, expected: 1602, got: 1629
 - {"method":"checkout","params":["LGCKAQXFOSKZGIWHNRNDITVBUUEOZXPYAVFDEPTBMQLYJRSMJCWH"],"id":"CHK_R5_148"}, expected: 1602, got: 1629
