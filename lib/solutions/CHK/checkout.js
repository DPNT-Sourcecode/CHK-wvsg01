        ...
        if (product.offers) {
            ...
            for (const offer of product.offers) {
                ...
                if (skuQuantities.includes(offer.onSku)) {
                    ...
                    offerDiscount = { sku, onSku: offer.onSku, discount: (offerDiscount.discount || 0) + discount }
                }
            }
            ...
            if (offerDiscount.discount && !discounts[offerDiscount.onSku]) { //&& (!discounts[offerDiscount.onSku] || discounts[offerDiscount.onSku] < offerDiscount.discount)) {
